...
enormous oversimplication: many things relate to many other things.
principal components anlaysis (PCA) is a method by which we can select
...
logtransform the z-scores of their data before beginning.
...
sensory variables. The last two variables are qualitative suppliments,
...
strech the eigenvectors to match the original matrix; bigger eigenvalues
...
*p*, or simply *λ*<sub>*j*</sub>/*p*. A commonly used computaitonal
trick for finding *p* is to simply take the trace of *R*, which is
necesarially the number of factors in the matrix.
...
![](PCA_Demo_BnB_files/figure-markdown_strict/unnamed-chunk-5-1.png)
...
![](PCA_Demo_BnB_files/figure-markdown_strict/unnamed-chunk-6-1.png)
...
![](PCA_Demo_BnB_files/figure-markdown_strict/unnamed-chunk-7-1.png)
...
![](PCA_Demo_BnB_files/figure-markdown_strict/unnamed-chunk-8-1.png)
...
Scores represent indivudal performance on 10 events by each athlete who
...
![](PCA_Demo_BnB_files/figure-markdown_strict/unnamed-chunk-11-1.png)
...
factors, the quantitative supplemnts of overall rank and score of each
...
explained threshold. Between the three guidlines of eignevalues &gt; 1
...
![](PCA_Demo_BnB_files/figure-markdown_strict/unnamed-chunk-13-1.png)

    plot(res2.pca,choix="ind")

![](PCA_Demo_BnB_files/figure-markdown_strict/unnamed-chunk-14-1.png)
